<%@ Page Title="" Language="C#" MasterPageFile="~/E-Library.Master" AutoEventWireup="true" CodeBehind="admin_book_issueing.aspx.cs" Inherits="E_Library_Management.admin_book_issueing" %>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Reg N.O"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>Book ID</label>
